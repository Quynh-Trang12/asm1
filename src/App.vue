...
<template>
  <nav
    class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow-sm py-3"
  >
    <div class="container">
      <a
  ...
  <main>
    ...
    <div class="container mt-4 mb-5">
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 text-center p-3 shadow-sm hover-card">
              <div class="card-body">
                ...
                <p class="card-text">
                  We handle all the logistics so you can focus on important
                  matters.
                </p>
              </div>
            </div>
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 text-center p-3 shadow-sm hover-card">
              <div class="card-body">
                ...
                <p class="card-text">
                  Our professionals bring years of experience to make your event
                  a success.
                </p>
              </div>
            </div>
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="card h-100 text-center p-3 shadow-sm hover-card">
              <div class="card-body">
                ...
                <p class="card-text">
                  Our clients love us! We prioritize your needs first and
                  foremost.
                </p>
              </div>
            </div>
      ...
      <section id="event-information" class="mb-5 scroll-margin-top">
        ...
        <div class="card p-4 mb-4 bg-white border-1 shadow-sm" role="search">
          <fieldset class="row g-3">
            <legend class="visually-hidden">
              <span role="heading" aria-level="3">Search Events</span>
            </legend>
            <div class="col-md-4">
                ...
                <div class="radio-options-grid">
                  ...
                  <div class="form-check">
                    <input
                      ...
                      v-model="searchCategory"
                    />
                    <label class="form-check-label" for="catBus"
                      >Business</label
                    >
                  </div>
                  <div class="form-check">
                    <input
                      ...
                      v-model="searchCategory"
                    />
                    <label class="form-check-label" for="catMark"
                      >Marketing</label
                    >
                  </div>
                  <div class="form-check">
          ...
          >
            ...
            <tbody>
              <tr v-for="event in paginatedEvents" :key="event.eventid">
                <td class="col-fit text-start pt-1 ps-1">
                  {{ event.eventid }}
                </td>
                ...
                <td class="text-center col-fit pe-1">
                  {{ event.durationhour }}
                </td>
              </tr>
